...
namespace VevaciousPlusPlus
{
  ...
  protected:
    ...
    virtual void RegisterDerivedParameters(std::vector<std::pair<std::string,std::string>> parameters);
  };
  ...
  //DerivedParameters only works with SARAH Manager since they are generated by SARAH
  inline void SlhaBlocksWithSpecialCasesManager::RegisterDerivedParameters(std::vector<std::pair<std::string,std::string>> parameters) {
