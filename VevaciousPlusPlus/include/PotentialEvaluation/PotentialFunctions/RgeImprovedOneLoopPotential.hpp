...
namespace VevaciousPlusPlus
{
  ...
  protected:
    ...
    // This provides the lines of Python to set the scale according to the
    // field values given by fv in the code generated by WriteAsPython in
    // PotentialFromPolynomialAndMasses, in the PotentialFunction function.
